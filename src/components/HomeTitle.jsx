            ...
            <div>
              <div className="relative group mt-4 w-min">
                <Link to="/all-products">
                  <button className="relative inline-block p-[2px] text-lg font-semibold leading-6 text-white bg-amber-500 shadow-2xl cursor-pointer rounded-2xl shadow-zinc-900 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95">
